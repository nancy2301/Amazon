...
# Customer age
may2$CustomerAge <- elapsed_months( april2$Billing_month,april2$Registration_date)
...
# Customer age
june2$CustomerAge <-  elapsed_months( april2$Billing_month,april2$Registration_date)
