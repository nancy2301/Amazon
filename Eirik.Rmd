...
+ fairly similar conversion rate among the Geographical areas
...
+ Visualize is the most popular, and has a higher rate of yes than any other
...
```{r}
All %>%
  filter(ProductsUsed == 1) %>%
  summarise(ma = max(totalBilled))
